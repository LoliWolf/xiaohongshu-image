# Xiaohongshu Image Generation System
...
5. **访问Web控制台**
- 前端界面：http://localhost:31007
- API文档：http://localhost:31006/healthz
- 外部SMTP服务：根据配置访问
...
1. 检查Mailhog：http://localhost:8025
2. 查看SMTP配置
3. 检查Worker日志中的错误信息
